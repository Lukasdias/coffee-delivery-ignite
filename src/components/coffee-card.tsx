...
export const CoffeeCard: FC<CoffeeCardProps> = memo(({ coffee, itemIndex }) => {
    ...
    const [addCoffeeToChart, getAmountOfGivenCoffeeInCart] = useCoffeeCart(
        (store) => [
        ...
        <AnimatePresence>
            {coffee && (
                ...
                >
                    ...
                    <div
                        className={
                            "flex flex-wrap w-full mb-4 gap-1 justify-center"
                        }
                    >
                        {tags.map((tag, index) => (
                    ...
                    <div className={"gap-6 w-full flex mt-auto"}>
                        <div className={"flex items-center gap-1"}>
                            ...
                            <span
                                className={
                                    "text-base-text font-bold font-baloo-2 text-2xl"
                                }
                            >
                                {price}
                            </span>
